...
public class FlelSolution extends AbstractSolution {
	...
	private static Integer rotationAngle = 0;

	public FlelSolution(int profondeur) {
		super(profondeur);
	}
	...
	public void drawSolutionk(Graphics drawingArea, int... arg) {
		...
		if((toDraw & DRAW_DOWN) != 0){
			drawSolutionk(drawingArea, x, y + diameter/2, diameter/2, depth-1, DRAW_DLR);
		}
